...
:--- | :--- | :---
[Lyned](https://github.com/cjquartey/lyned) | 🖋️ Converts raster images into editable SVG line art using deep learning, with a browser-based vector editor and real-time collaboration (React, FastAPI, PyTorch, Node, Redis) | [![GitHub stars](https://img.shields.io/github/stars/cjquartey/lyned?style=flat&label=)](https://github.com/cjquartey/lyned/stargazers)
[Glow Reach Health](https://github.com/daisy-py-bot/glow-reach-health) | 🌸 SheaGlow — a telederm platform with an AI SkinScanner and intake flow for patient skin health (React, FastAPI, MongoDB, Supabase) | [![GitHub stars](https://img.shields.io/github/stars/daisy-py-bot/glow-reach-health?style=flat&label=)](https://github.com/daisy-py-bot/glow-reach-health/stargazers)
